...
function alterar(cpf){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        if (cliente.cpf == cpf){
            ...
            document.getElementById("telefonedatia").value = cliente.telefonedatia  
...
function salvar(){
    ...
    let telefonedatia = document.getElementById("telefonedatia").value    
    ...
    if (clienteAlterado == null){
        ...
        clienteAlterado.telefonedatia = telefonedatia        
...
function exibirDados(){
    ...
    for(let i = 0; i < clientes.length; i++){
        ...
        <tr>
            ...
            <td>${clientes[i].telefonedatia}</td>            
...
function limparForm(){
    ...
    document.getElementById("telefonedatia").value = ""    
